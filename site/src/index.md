...
display(html`<div class="grid-2">
  <div class="panel"><h3>House</h3>${seatChart(houseDist, 218, {width: colW, label: "House"})}</div>
  <div class="panel"><h3>Senate</h3>${seatChart(senDist, 51, {width: colW, label: "Senate"})}</div>
</div>`);
```
